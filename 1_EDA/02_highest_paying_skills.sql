...
- Calculate the median salary for each skill required in data engineer position
- Focus on remote positions with specified salaries
- include skill frequency to identify both salary and demand

WHY?
    - Helps identify which skills command the highest compensation while also showing how coomon those skills are, providing a more complete picture for skill development priorities
    - The median is used instead fo the average to reduce the impact of outlier salaries.
*/
